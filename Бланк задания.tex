...
\newcolumntype{P}[1]{>{\RaggedRight\arraybackslash}p{\dimexpr #1 - 2\tabcolsep - 1.5\arrayrulewidth\relax}}
\newcolumntype{C}[1]{>{\centering\arraybackslash}p{\dimexpr #1 - 2\tabcolsep - 1.5\arrayrulewidth\relax}}
...
\begin{center}
    ...
    Соловьевой Анастасии Николаевне, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения для учёта и контроля приёма лекарств»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих программных продуктов для учёта и контроля приёма лекарств        & 8                  & 06.04.2026    &                     \\ \hline
    Задача 1.2. Анализ программных инструментов разработки веб-приложения                            & 6                  & 12.04.2026    &                     \\ \hline
    Задача 1.3. Формулировка цели и задач работы                                                     & 6                  & 18.04.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 2. Проектирование веб-приложения}}                                                                          \\ \hline
    Задача 2.1. Анализ целевой аудитории                                                             & 5                  & 22.04.2026    &                     \\ \hline
    Задача 2.2. Описание функциональности приложения (диаграмма вариантов использования, user story) & 7                  & 28.04.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (ER-диаграмма, логическая и физическая схемы БД)        & 8                  & 06.05.2026    &                     \\ \hline
    ...
    Задача 3.1. Разработка базовой структуры приложения и вёрстка шаблонов страниц                   & 10                 & 22.05.2026    &                     \\ \hline
    Задача 3.2. Реализация системы аутентификации и разграничения прав доступа по ролям              & 7                  & 26.05.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для управления лекарствами и курсами лечения              & 10                 & 30.05.2026    &                     \\ \hline
    Задача 3.4. Реализация системы учёта приёмов лекарств и агрегации статистики                     & 12                 & 03.06.2026    &                     \\ \hline
    Задача 3.5. Реализация загрузки и выгрузки файлов                                                & 6                  & 06.06.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с кодом проекта                                             & 3                  & 02.04.2026    &                     \\ \hline
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.55\textwidth} @{}}
    Дата выдачи задания           &
    \hfill «\underline{02}» \quad \underline{апреля} \quad 2026~г. \\
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}
    ...
    «\underline{02}» \quad \underline{апреля} \quad 2026~г. &
    \centering \rule{3.5cm}{0.4pt} \par \footnotesize (подпись) &
    \hfill А. Н. Соловьева                                           \\
\end{tabularx}
}
